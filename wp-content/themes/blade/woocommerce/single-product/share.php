...
if ( !empty( $product_socials ) ) {
	...
	$social_tumblr = blade_grve_option( 'product_social', '', 'tumblr' );
...
?>
	...
	<div class="grve-product-social grve-border">
		<ul>
			...
			<li class="grve-zoomIn"><a href="<?php echo esc_url( $grve_permalink ); ?>" title="<?php echo esc_attr( $grve_title ); ?>" class="<?php echo esc_attr( $social_shape_class_string ); ?> grve-social-share-tumblr"><i class="fa fa-tumblr"></i></a></li>
			<?php } ?>
