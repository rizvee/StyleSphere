...
if ( 'theme' == blade_grve_option( 'product_image_thumb_style', 'theme' ) ) {
	...
	if ( $attachment_ids ) {
		...
		<div class="<?php echo esc_attr( $product_gallery_class_string ); ?>"><?php
			...
			foreach ( $attachment_ids as $attachment_id ) {
				...
				$image_title_caption = blade_grve_option( 'product_gallery_title_caption', 'none' );
				...
				echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<a href="%s" class="%s" data-title="%s" data-desc="%s" data-rel="prettyPhoto[product-gallery]">%s</a>', $image_link, $image_class, $product_image_title, $product_image_caption, $image ), $attachment_id, $post->ID, $image_class );
