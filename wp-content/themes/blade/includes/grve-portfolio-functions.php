 ...
 */
if ( !function_exists('blade_grve_print_portfolio_feature_image') ) {
 ...
 */
if ( !function_exists('blade_grve_print_portfolio_media') ) {
 ...
 */
if ( !function_exists('blade_grve_print_portfolio_video') ) {
...
if ( !function_exists('blade_grve_check_portfolio_details') ) {
 ...
 */
if ( !function_exists('blade_grve_print_recent_portfolio_items') ) {
...
if ( !function_exists('blade_grve_print_portfolio_social') ) {
	function blade_grve_print_portfolio_social() {
		...
		if ( !empty( $portfolio_socials ) ) {
			...
			$portfolio_tumblr = blade_grve_option( 'portfolio_social', '', 'tumblr' );
