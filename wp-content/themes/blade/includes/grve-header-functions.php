 ...
 * Print Logo
 */
if( !function_exists( 'blade_grve_print_logo' ) ) {
 ...
 * Get Logo Data
 */
if( !function_exists( 'blade_grve_print_logo_data' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_header_title' ) ) {
	function blade_grve_header_title() {
		...
		if( blade_grve_woocommerce_enabled() ) {
			...
			if ( is_shop() && !is_search() ) {
				...
				$header_title_data = array(
					'title' => $page_title,
					'description' => $page_description,
				);
				return apply_filters( 'blade_grve_header_title_data', $header_title_data );
		...
		if ( is_front_page() && is_home() ) {
			...
			if ( 'custom' === blade_grve_option( 'blog_title' ) ) {
				$page_title = blade_grve_option( 'blog_custom_title' );
				$page_description = blade_grve_option( 'blog_custom_description' );
			}
 ...
 */
if( !function_exists( 'blade_grve_check_title_visibility' ) ) {
...
if( !function_exists( 'blade_grve_print_title_bg_image' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_title' ) ) {
		...
		if ( blade_grve_check_title_visibility() ) {
			...
			if ( is_singular() || $grve_woo_shop  ) {
				...
				if ( 'custom' == $grve_page_title_custom ) {
					...
					if ( is_singular('product' ) && 'simple' == blade_grve_option( 'product_title_style' ) ) { 
						return;
					}					
				}
 ...
 * Prints Anchor Menu
 */
if( !function_exists( 'blade_grve_print_anchor_menu' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_breadcrumbs' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_text' ) ) {
	function blade_grve_print_header_top_bar_text( $text ) {
		if ( !empty( $text ) ) {
?>
			<li class="grve-topbar-item grve-topbar-item-text"><p><?php echo do_shortcode( $text ); ?></p></li>
<?php
		}
	}
}
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_nav' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_search' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_form' ) ) {
...
?>
		<li class="grve-topbar-item grve-topbar-item-form"><a href="<?php echo esc_attr( $modal_id ); ?>" class="grve-icon-envelope grve-toggle-modal"></a></li>
<?php
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_socials' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar_language_selector' ) ) { 
 ...
 */
if( !function_exists( 'blade_grve_print_header_top_bar' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_check_header_elements_visibility_responsive' ) ) {
...
if( !function_exists( 'blade_grve_check_header_elements_visibility' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_elements' ) ) {
										...
										foreach ( $social_options as $key => $value ) {
											if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
												if ( 'skype' == $key ) {
													...
													echo '<li class="grve-header-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												}
											}
										}
 ...
 * Prints header elements e.g: social, language selector, search
 */
if( !function_exists( 'blade_grve_print_header_elements_responsive' ) ) {
										...
										foreach ( $social_options as $key => $value ) {
											if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
												if ( 'skype' == $key ) {
													...
													echo '<li class="grve-header-responsive-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												}
											}
										}
	?>
 ...
 */
if( !function_exists( 'blade_grve_print_login_responsive_button' ) ) {
...
if( !function_exists( 'blade_grve_print_form_modals' ) ) {
 ...
 * Prints Search modal
 */
if( !function_exists( 'blade_grve_print_search_modal' ) ) {
...
?>
			<div id="grve-search-modal" class="grve-modal">
				<div class="grve-modal-wrapper">
					<div class="grve-modal-content">
						<div class="grve-modal-item">
							<?php echo blade_grve_modal_wpsearch(); ?>
						</div>
					</div>
				</div>
			</div>
...
if( !function_exists( 'blade_grve_print_language_modal' ) ) {
...
if( !function_exists( 'blade_grve_print_social_modal' ) ) {
							...
							foreach ( $social_options as $key => $value ) {
								if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
									if ( 'skype' == $key ) {
										...
										echo '<li><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer"><span>' . esc_html( $blade_grve_social_list[$key] ) . '</span></a></li>';
									}
								}
							}
			?>
 ...
 * Gets side area data
 */
if( !function_exists( 'blade_grve_get_sidearea_data' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_sidearea_button' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_header_hiddenarea_button' ) ) {
 ...
 * Prints Side Area
 */
if( !function_exists( 'blade_grve_print_side_area' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_print_cart_responsive_link' ) ) {
 ...
 * Prints Shop Cart
 */
if( !function_exists( 'blade_grve_print_cart_area' ) ) {
 ...
 * Prints Hidden Menu
 */
if( !function_exists( 'blade_grve_print_hidden_menu' ) ) {
...
if( !function_exists( 'blade_grve_print_item_nav_link' ) ) {
 ...
 */
if( !function_exists( 'blade_grve_check_theme_loader_visibility' ) ) {
