...
function blade_grve_get_replaced_image() {
	...
	check_ajax_referer( 'blade-grve-get-replaced-image', '_grve_nonce' );
...
function blade_grve_get_admin_feature_slider_media() {
	...
	check_ajax_referer( 'blade-grve-get-feature-slider-media', '_grve_nonce' );
...
function blade_grve_get_map_point() {
	...
	check_ajax_referer( 'blade-grve-get-map-point', '_grve_nonce' );
...
function blade_grve_print_admin_feature_item_video_options( $item ) {
	...
	$video_device = blade_grve_array_value( $item, 'video_device', 'no' );
	...
	blade_grve_print_admin_option(
		array(
			'type' => 'select-boolean',
			'name' => 'grve_single_item_video_device',
			'value' => $video_device,
			'label' => esc_html__( 'Show video on devices', 'blade' ),
		)
	);
	...
	blade_grve_print_admin_option(
		array(
			...
			'value' => $video_muted,
			'label' => array(
				"title" => esc_html__( 'Muted', 'blade' ),
				"info" => esc_html__( 'Note: Due to new browser/device restrictions, videos with sound are no longer allowed to autoplay in Chrome, Safari and mobile devices. In these cases videos will be automatically muted.', 'blade' ),
			),
		)
	);
	blade_grve_print_admin_option(
...
function blade_grve_admin_save_feature_section( $post_id ) {
	...
	if ( isset( $_POST['grve_page_feature_element'] ) ) {
		...
		$feature_section['feature_settings'] = array (
			'element' => sanitize_text_field( $_POST['grve_page_feature_element'] ),
			'size' => sanitize_text_field( $_POST['grve_page_feature_size'] ),
			'height' => sanitize_text_field( $_POST['grve_page_feature_height'] ),
			'min_height' => sanitize_text_field( $_POST['grve_page_feature_min_height'] ),
			'header_position' => sanitize_text_field( $_POST['grve_page_feature_header_position'] ),
			'bg_color' => sanitize_text_field( $_POST['grve_page_feature_bg_color'] ),
			'bg_color_custom' => sanitize_text_field( $_POST['grve_page_feature_bg_color_custom'] ),
		);


		//Feature Revolution Slider
		if ( isset( $_POST['grve_page_revslider'] ) ) {
			$feature_section['revslider_alias'] = sanitize_text_field( $_POST['grve_page_revslider'] );
		}
		...
		if ( isset( $_POST['grve_single_item_title'] ) ) {
			...
			$feature_section['single_item'] = array (
				...
				'title' => wp_filter_post_kses( $_POST['grve_single_item_title'] ),
				'title_color' => sanitize_text_field( $_POST['grve_single_item_title_color'] ),
				'title_color_custom' => sanitize_text_field( $_POST['grve_single_item_title_color_custom'] ),
				'title_tag' => sanitize_text_field( $_POST['grve_single_item_title_tag'] ),
				'caption' => wp_filter_post_kses( $_POST['grve_single_item_caption'] ),
				'caption_color' => sanitize_text_field( $_POST['grve_single_item_caption_color'] ),
				'caption_color_custom' => sanitize_text_field( $_POST['grve_single_item_caption_color_custom'] ),
				'caption_tag' => sanitize_text_field( $_POST['grve_single_item_caption_tag'] ),
				'subheading' => wp_filter_post_kses( $_POST['grve_single_item_subheading'] ),
				'subheading_color' => sanitize_text_field( $_POST['grve_single_item_subheading_color'] ),
				'subheading_color_custom' => sanitize_text_field( $_POST['grve_single_item_subheading_color_custom'] ),
				'subheading_tag' => sanitize_text_field( $_POST['grve_single_item_subheading_tag'] ),
				'content_position' => sanitize_text_field( $_POST['grve_single_item_content_position'] ),
				'content_animation' => sanitize_text_field( $_POST['grve_single_item_content_animation'] ),
				'content_image_id' => sanitize_text_field( $_POST['grve_single_item_content_image_id'] ),
				'content_image_size' => sanitize_text_field( $_POST['grve_single_item_content_image_size'] ),
				'content_image_max_height' => sanitize_text_field( $_POST['grve_single_item_content_image_max_height'] ),
				'pattern_overlay' => sanitize_text_field( $_POST['grve_single_item_pattern_overlay'] ),
				'color_overlay' => sanitize_text_field( $_POST['grve_single_item_color_overlay'] ),
				'color_overlay_custom' => sanitize_text_field( $_POST['grve_single_item_color_overlay_custom'] ),
				'opacity_overlay' => sanitize_text_field( $_POST['grve_single_item_opacity_overlay'] ),
				'bg_image_id' => sanitize_text_field( $_POST['grve_single_item_bg_image_id'] ),
				'bg_position' => sanitize_text_field( $_POST['grve_single_item_bg_position'] ),
				'bg_tablet_sm_position' => sanitize_text_field( $_POST['grve_single_item_bg_tablet_sm_position'] ),
				'image_effect' => sanitize_text_field( $_POST['grve_single_item_image_effect'] ),
				'video_webm' => sanitize_text_field( $_POST['grve_single_item_video_webm'] ),
				'video_mp4' => sanitize_text_field( $_POST['grve_single_item_video_mp4'] ),
				'video_ogv' => sanitize_text_field( $_POST['grve_single_item_video_ogv'] ),
				'video_poster' => sanitize_text_field( $_POST['grve_single_item_video_poster'] ),
				'video_device' => sanitize_text_field( $_POST['grve_single_item_video_device'] ),
				'video_loop' => sanitize_text_field( $_POST['grve_single_item_video_loop'] ),
				'video_muted' => sanitize_text_field( $_POST['grve_single_item_video_muted'] ),
				'video_effect' => sanitize_text_field( $_POST['grve_single_item_video_effect'] ),

				'button' => array(
					'id' => sanitize_text_field( $_POST['grve_single_item_button_id'] ),
					'text' => sanitize_text_field( $_POST['grve_single_item_button_text'] ),
					'url' => sanitize_text_field( $_POST['grve_single_item_button_url'] ),
					'target' => sanitize_text_field( $_POST['grve_single_item_button_target'] ),
					'color' => sanitize_text_field( $_POST['grve_single_item_button_color'] ),
					'hover_color' => sanitize_text_field( $_POST['grve_single_item_button_hover_color'] ),
					'size' => sanitize_text_field( $_POST['grve_single_item_button_size'] ),
					'shape' => sanitize_text_field( $_POST['grve_single_item_button_shape'] ),
					'type' => sanitize_text_field( $_POST['grve_single_item_button_type'] ),
					'class' => sanitize_text_field( $_POST['grve_single_item_button_class'] ),
				),
				'button2' => array(
					'id' => sanitize_text_field( $_POST['grve_single_item_button2_id'] ),
					'text' => sanitize_text_field( $_POST['grve_single_item_button2_text'] ),
					'url' => sanitize_text_field( $_POST['grve_single_item_button2_url'] ),
					'target' => sanitize_text_field( $_POST['grve_single_item_button2_target'] ),
					'color' => sanitize_text_field( $_POST['grve_single_item_button2_color'] ),
					'hover_color' => sanitize_text_field( $_POST['grve_single_item_button2_hover_color'] ),
					'size' => sanitize_text_field( $_POST['grve_single_item_button2_size'] ),
					'shape' => sanitize_text_field( $_POST['grve_single_item_button2_shape'] ),
					'type' => sanitize_text_field( $_POST['grve_single_item_button2_type'] ),
					'class' => sanitize_text_field( $_POST['grve_single_item_button2_class'] ),
				),
				'arrow_enabled' => sanitize_text_field( $_POST['grve_single_item_arrow_enabled'] ),
				'arrow_align' => sanitize_text_field( $_POST['grve_single_item_arrow_align'] ),
				'arrow_color' => sanitize_text_field( $_POST['grve_single_item_arrow_color'] ),
				'arrow_color_custom' => sanitize_text_field( $_POST['grve_single_item_arrow_color_custom'] ),
				'el_class' => sanitize_text_field( $_POST['grve_single_item_el_class'] ),
		...
		if ( isset( $_POST['grve_slider_item_id'] ) ) {
			...
			for ( $i=0; $i < $num_of_images; $i++ ) {
				...
				$slide = array (
					...
					'bg_image_id' => sanitize_text_field( $_POST['grve_slider_item_bg_image_id'][ $i ] ),
					...
					'title_color_custom' => sanitize_text_field( $_POST['grve_slider_item_title_color_custom'][ $i ] ),
					...
					'caption_color_custom' => sanitize_text_field( $_POST['grve_slider_item_caption_color_custom'][ $i ] ),
					'caption_tag' => sanitize_text_field( $_POST['grve_slider_item_caption_tag'][ $i ] ),
					'subheading' => wp_filter_post_kses( $_POST['grve_slider_item_subheading'][ $i ] ),
					'subheading_color' => sanitize_text_field( $_POST['grve_slider_item_subheading_color'][ $i ] ),
					'subheading_color_custom' => sanitize_text_field( $_POST['grve_slider_item_subheading_color_custom'][ $i ] ),
					'subheading_tag' => sanitize_text_field( $_POST['grve_slider_item_subheading_tag'][ $i ] ),
					'content_position' => sanitize_text_field( $_POST['grve_slider_item_content_position'][ $i ] ),
					'content_animation' => sanitize_text_field( $_POST['grve_slider_item_content_animation'][ $i ] ),
					'content_image_id' => sanitize_text_field( $_POST['grve_slider_item_content_image_id'][ $i ] ),
					'content_image_size' => sanitize_text_field( $_POST['grve_slider_item_content_image_size'][ $i ] ),
					'content_image_max_height' => sanitize_text_field( $_POST['grve_slider_item_content_image_max_height'][ $i ] ),
					...
					'color_overlay_custom' => sanitize_text_field( $_POST['grve_slider_item_color_overlay_custom'][ $i ] ),
					'opacity_overlay' => sanitize_text_field( $_POST['grve_slider_item_opacity_overlay'][ $i ] ),
					'button' => array(
						'id' => sanitize_text_field( $_POST['grve_slider_item_button_id'][ $i ] ),
						'text' => sanitize_text_field( $_POST['grve_slider_item_button_text'][ $i ] ),
						'url' => sanitize_text_field( $_POST['grve_slider_item_button_url'][ $i ] ),
						'target' => sanitize_text_field( $_POST['grve_slider_item_button_target'][ $i ] ),
						'color' => sanitize_text_field( $_POST['grve_slider_item_button_color'][ $i ] ),
						'hover_color' => sanitize_text_field( $_POST['grve_slider_item_button_hover_color'][ $i ] ),
						'size' => sanitize_text_field( $_POST['grve_slider_item_button_size'][ $i ] ),
						'shape' => sanitize_text_field( $_POST['grve_slider_item_button_shape'][ $i ] ),
						'type' => sanitize_text_field( $_POST['grve_slider_item_button_type'][ $i ] ),
						'class' => sanitize_text_field( $_POST['grve_slider_item_button_class'][ $i ] ),
					),
					'button2' => array(
						'id' => sanitize_text_field( $_POST['grve_slider_item_button2_id'][ $i ] ),
						'text' => sanitize_text_field( $_POST['grve_slider_item_button2_text'][ $i ] ),
						'url' => sanitize_text_field( $_POST['grve_slider_item_button2_url'][ $i ] ),
						'target' => sanitize_text_field( $_POST['grve_slider_item_button2_target'][ $i ] ),
						'color' => sanitize_text_field( $_POST['grve_slider_item_button2_color'][ $i ] ),
						'hover_color' => sanitize_text_field( $_POST['grve_slider_item_button2_hover_color'][ $i ] ),
						'size' => sanitize_text_field( $_POST['grve_slider_item_button2_size'][ $i ] ),
						'shape' => sanitize_text_field( $_POST['grve_slider_item_button2_shape'][ $i ] ),
						'type' => sanitize_text_field( $_POST['grve_slider_item_button2_type'][ $i ] ),
						'class' => sanitize_text_field( $_POST['grve_slider_item_button2_class'][ $i ] ),
					),
					'arrow_enabled' => sanitize_text_field( $_POST['grve_slider_item_arrow_enabled'][ $i ] ),
					'arrow_align' => sanitize_text_field( $_POST['grve_slider_item_arrow_align'][ $i ] ),
					'arrow_color' => sanitize_text_field( $_POST['grve_slider_item_arrow_color'][ $i ] ),
					'arrow_color_custom' => sanitize_text_field( $_POST['grve_slider_item_arrow_color_custom'][ $i ] ),
		...
		if( !empty( $slider_items ) ) {
			...
			$feature_section['slider_settings'] = array (
				...
				'slider_effect' => sanitize_text_field( $_POST['grve_page_slider_settings_effect'] ),
			);
		}
		...
		if( !empty( $map_items ) ) {
			...
			$feature_section['map_settings'] = array (
				...
				'disable_style' => sanitize_text_field( $_POST['grve_page_feature_map_disable_style'] ),
			);
