...
============================================================================= */
	...
	.grve-logo.grve-logo-text a {
		line-height: " . blade_grve_option( 'header_top_height', 120 ) . "px;
	}
	...
	.grve-logo-text a,
	#grve-main-menu .grve-wrapper > ul > li > a,
	#grve-main-header.grve-slide-menu .grve-wrapper > ul > li > .grve-arrow,
	.grve-header-element > a,
	.grve-header-element .grve-purchased-items {
	...
	#grve-main-menu .grve-wrapper > ul > li.current-menu-ancestor > a,
	#grve-main-menu .grve-wrapper > ul > li:hover > a,
	#grve-main-header.grve-slide-menu .grve-wrapper > ul > li > .grve-arrow:hover,
	.grve-header-element > a:hover ,
	...
	#grve-main-menu .grve-wrapper > ul > li ul li a,
	#grve-main-header.grve-slide-menu .grve-wrapper > ul > li ul li .grve-arrow,
	#grve-main-header.grve-light #grve-main-menu .grve-wrapper > ul > li.megamenu > ul > li:hover > a {
		color: " . blade_grve_option( 'side_header_submenu_text_color' ) . ";
	}

	#grve-main-menu .grve-wrapper > ul > li ul li a:hover,
	#grve-main-header.grve-slide-menu .grve-wrapper > ul > li ul li .grve-arrow:hover,
	#grve-main-menu .grve-wrapper > ul > li ul li.current-menu-item > a {
	...
	.grve-anchor-menu .grve-anchor-wrapper.grve-sticky {
		width: calc(100% - " . blade_grve_option( 'header_side_width', 120 ) . "px);
	}

	#grve-body.grve-boxed .grve-anchor-menu .grve-anchor-wrapper.grve-sticky {
		max-width: calc(" . blade_grve_option( 'boxed_size', 1220 ) . "px - " . blade_grve_option( 'header_side_width', 120 ) . "px);
	}
...
============================================================================= */
	...
	========================================================================= */
		...
		$css .= "
			...
			#grve-header.grve-sticky-header.grve-shrink .grve-logo.grve-logo-text a,
			#grve-header.grve-sticky-header.grve-advanced .grve-logo.grve-logo-text a {
				line-height: " . blade_grve_option( 'header_sticky_shrink_height', 20 ) . "px;
			}
...
function blade_grve_print_css_colors() {

	$blade_grve_colors = blade_grve_get_color_array();

	$css = '';

	foreach ( $blade_grve_colors as $key => $value ) {
...
$css .= blade_grve_print_css_colors();
...
/* GDPR Privacy
============================================================================= */
$blade_grve_privacy_bar_bg_color = blade_grve_option( 'privacy_bar_bg_color', '#000000' );
$css .= "

#grve-privacy-bar {
	background-color: rgba(" . blade_grve_hex2rgb( $blade_grve_privacy_bar_bg_color ) . "," . blade_grve_option( 'privacy_bar_bg_opacity', '0.90') . ");
	color: " . blade_grve_option( 'privacy_bar_text_color' ) . ";
}

.grve-privacy-agreement {
	background-color: " . blade_grve_option( 'privacy_bar_button_bg_color' ) . ";
	color: " . blade_grve_option( 'privacy_bar_button_text_color' ) . ";
}

.grve-privacy-refresh-btn {
	background-color: " . blade_grve_option( 'privacy_modal_button_bg_color' ) . ";
	color: " . blade_grve_option( 'privacy_modal_button_text_color' ) . ";
}
...
.grve-privacy-agreement:hover {
	background-color: " . blade_grve_option( 'privacy_bar_button_bg_hover_color' ) . ";
}

.grve-privacy-refresh-btn:hover {
	background-color: " . blade_grve_option( 'privacy_modal_button_bg_hover_color' ) . ";
}
...
function blade_grve_print_gap_size( $grve_gap_size = array()) {

	$css = '';

	foreach ( $grve_gap_size as $size ) {

		$grve_gap_size = $size['gap'];
		$grve_gap_half_size = $size['gap'] * 0.5;

		$css .= "

			.grve-section.grve-column-gap-" . esc_attr( $size['gap'] ) . " .grve-row {
				margin-left: -" . esc_attr( $grve_gap_half_size ) . "px;
				margin-right: -" . esc_attr( $grve_gap_half_size ) . "px;
			}
			.grve-section.grve-column-gap-" . esc_attr( $size['gap'] ) . " .grve-column,
			.grve-section.grve-fullwidth.grve-column-gap-" . esc_attr( $size['gap'] ) . " .grve-column {
				padding-left: " . esc_attr( $grve_gap_half_size ) . "px;
				padding-right: " . esc_attr( $grve_gap_half_size ) . "px;
			}
			.grve-section.grve-fullwidth.grve-column-gap-" . esc_attr( $size['gap'] ) . " .grve-row {
				padding-left: " . esc_attr( $grve_gap_half_size ) . "px;
				padding-right: " . esc_attr( $grve_gap_half_size ) . "px;
				margin-left: 0px;
				margin-right: 0px;
...
$css .= blade_grve_print_gap_size( $grve_gap_size );
