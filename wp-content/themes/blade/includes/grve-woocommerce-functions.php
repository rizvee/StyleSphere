...
function blade_grve_woo_theme_setup() {

	$product_image_thumb_style = blade_grve_option( 'product_image_thumb_style', 'theme' );
	if( 'woo' == $product_image_thumb_style ) {
		if( blade_grve_visibility( 'product_gallery_woo_zoom' ) ) {
			add_theme_support( 'wc-product-gallery-zoom' );
		}
		if( blade_grve_visibility( 'product_gallery_woo_lightbox' ) ) {
			add_theme_support( 'wc-product-gallery-lightbox' );
		}
		if( blade_grve_visibility( 'product_gallery_woo_slider' ) ) {
			add_theme_support( 'wc-product-gallery-slider' );
		}
	}

}
add_action( 'after_setup_theme', 'blade_grve_woo_theme_setup' );
...
add_action( 'blade_grve_woocommerce_shop_loop_product_price', 'woocommerce_template_loop_price', 10 );
add_action( 'blade_grve_woocommerce_shop_loop_add_to_cart', 'woocommerce_template_loop_add_to_cart', 10 );
